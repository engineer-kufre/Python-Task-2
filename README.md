...
5. If the program is run consecutively by two different users, their details get stored in a container (make sure you can identify who has each detail). Print out each item in the container after all users are done.